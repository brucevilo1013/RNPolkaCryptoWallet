...
const CONFIG_URL = 'https://chainx-config.oss-cn-hangzhou.aliyuncs.com/rnpolkacryptowallet.json'

const DEFAULT_DOWNLOAD_DEST = `${RNFS.MainBundlePath}/rnpolkacryptowallet.json`
