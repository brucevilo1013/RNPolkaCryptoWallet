...
class CoinDetails extends Component {
  ...
  Load() {
    // 清除缓存
    // Clear the cache
    let REQUEST_URL = 'https://api.rnpolkacryptowallet.io:8080/tx_list_for_redis'
    let params =
  ...
  LoadTxList(pageNum = 1) {
    ...
    let REQUEST_URL = 'https://api.rnpolkacryptowallet.io:8080/tx_list'
  ...
  GetStakingOption() {
    ...
    let REQUEST_URL = 'https://api.rnpolkacryptowallet.io:8080/tx_money_date'
    let params =
      '{"user_address":"' +
