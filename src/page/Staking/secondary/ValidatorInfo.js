...
class ValidatorInfo extends Component {
   ...
   */
  Loadmore() {
    const REQUEST_URL = 'https://api.rnpolkacryptowallet.io:8080/staking_list_alexander'
  ...
  getStakingOption(address) {
    ;(async () => {
      ...
      const REQUEST_URL = 'https://api.rnpolkacryptowallet.io:8080/staking_chart_alexander'
